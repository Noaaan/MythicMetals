...
public class MythicOreFeatureProvider {
    public static void initConfiguredFeatures(BootstrapContext<ConfiguredFeature<?, ?>> registerable) {
        // above 0
        OreFeatureHelper.configuredFeature(registerable, ORE_AQUARIUM, STONE_RULE, MythicMaterials.AQUARIUM.blockSet().ore().block(), MythicOreConfigs.AQUARIUM);
        OreFeatureHelper.configuredFeature(registerable, ORE_BANGLUM, STONE_RULE, MythicMaterials.BANGLUM.blockSet().ore().block(), MythicOreConfigs.BANGLUM);
        OreFeatureHelper.configuredFeature(registerable, ORE_KYBER, STONE_RULE, MythicMaterials.KYBER.blockSet().ore().block(), MythicOreConfigs.KYBER);
        OreFeatureHelper.configuredFeature(registerable, ORE_MANGANESE, STONE_RULE, MythicMaterials.MANGANESE.blockSet().ore().block(), MythicOreConfigs.MANGANESE);
        OreFeatureHelper.configuredFeature(registerable, ORE_OSMIUM, STONE_RULE, MythicMaterials.OSMIUM.blockSet().ore().block(), MythicOreConfigs.OSMIUM);
        OreFeatureHelper.configuredFeature(registerable, ORE_PLATINUM, STONE_RULE, MythicMaterials.PLATINUM.blockSet().ore().block(), MythicOreConfigs.PLATINUM);
        OreFeatureHelper.configuredFeature(registerable, ORE_QUADRILLUM, STONE_RULE, MythicMaterials.QUADRILLUM.blockSet().ore().block(), MythicOreConfigs.QUADRILLUM);
        OreFeatureHelper.configuredFeature(registerable, ORE_RUNITE, RUNITE_TARGETS, MythicOreConfigs.RUNITE);
        OreFeatureHelper.configuredFeature(registerable, ORE_SILVER, STONE_RULE, MythicMaterials.SILVER.blockSet().ore().block(), MythicOreConfigs.SILVER);
        OreFeatureHelper.configuredFeature(registerable, ORE_TIN, STONE_RULE, MythicMaterials.TIN.blockSet().ore().block(), MythicOreConfigs.TIN);
        // usually below 0
        OreFeatureHelper.configuredFeature(registerable, ORE_ADAMANTITE, ADAMANTITE_TARGETS, MythicOreConfigs.ADAMANTITE);
        OreFeatureHelper.configuredFeature(registerable, ORE_CALCITE_KYBER, CALCITE_RULE, MythicMaterials.KYBER.blockSet().oreVariants().get("calcite").block(), MythicOreConfigs.CALCITE_KYBER);
        ...
        // nether
        OreFeatureHelper.configuredFeature(registerable, ORE_NETHER_BANGLUM, NETHERRACK_RULE, MythicMaterials.BANGLUM.blockSet().oreVariants().get("nether").block(), MythicOreConfigs.NETHER_BANGLUM);
        OreFeatureHelper.configuredFeature(registerable, ORE_MIDAS_GOLD, NETHERRACK_RULE, MythicMaterials.MIDAS_GOLD.blockSet().ore().block(), MythicOreConfigs.MIDAS_GOLD);
        OreFeatureHelper.configuredFeature(registerable, ORE_PALLADIUM, NETHERRACK_RULE, MythicMaterials.PALLADIUM.blockSet().ore().block(), MythicOreConfigs.PALLADIUM);
        OreFeatureHelper.configuredFeature(registerable, ORE_STORMYX, STORMYX_TARGETS, MythicOreConfigs.STORMYX);
        // end ore
        OreFeatureHelper.configuredFeature(registerable, ORE_END_STARRITE, END_STONE_RULE, MythicMaterials.STARRITE.blockSet().oreVariants().get("end_stone").block(), MythicOreConfigs.END_STARRITE);
    }
