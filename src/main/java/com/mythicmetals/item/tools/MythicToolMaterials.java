...
public class MythicToolMaterials {
    public static final ToolMaterial ADAMANTITE  = new ToolMaterial(getInverseTag(4), 1024, 7.0f, 5f, 16, TagKey.create(Registries.ITEM, RegistryHelper.id("ingots/adamantite")));
    public static final ToolMaterial AEGIS_RED = new ToolMaterial(getInverseTag(4), 2170, 8.0F, 6.0F, 25, TagKey.create(Registries.ITEM, RegistryHelper.id("ingots/palladium")));
