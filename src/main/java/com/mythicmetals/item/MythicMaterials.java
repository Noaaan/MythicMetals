...
public class MythicMaterials {
    ...
    public static final Material MIDAS_GOLD = Material.Builder.create("midas_gold", MaterialType.INGOT)
        ...
        .addExtraItem(MIDAS_GOLD_DAGGER, MythicTools.MIDAS_GOLD_DAGGER)
        .addExtraItem(MIDAS_GOLD_SHORTSWORD, MythicTools.MIDAS_GOLD_SHORTSWORD)
        .addExtraItem(MIDAS_GOLD_SWORD, MythicTools.MIDAS_GOLD_SWORD)
        .addExtraItem(SOCKETED_MIDAS_GOLD_SWORD, MythicTools.SOCKETED_MIDAS_GOLD_SWORD)
        .addExtraItem(GILDED_MIDAS_GOLD_SWORD, MythicTools.GILDED_MIDAS_GOLD_SWORD)
        .addExtraItem(MAXED_GILDED_MIDAS_GOLD_SWORD, MythicTools.MAXED_GILDED_MIDAS_GOLD_SWORD)
        .addExtraItem(ROYAL_MIDAS_GOLD_SWORD, MythicTools.ROYAL_MIDAS_GOLD_SWORD)
        .addExtraItem(ROYAL_MIDAS_GOLD_BROADSWORD, MythicTools.ROYAL_MIDAS_GOLD_BROADSWORD)
