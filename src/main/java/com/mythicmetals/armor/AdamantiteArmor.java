...
public class AdamantiteArmor extends ArmorItem implements CustomArmorModelItem {
    ...
    public AdamantiteArmor(EquipmentType type, Settings settings) {
        this(MythicArmorMaterials.ADAMANTITE, type, settings);
    }

    public AdamantiteArmor(ArmorMaterial material, EquipmentType type, Settings settings) {
    ...
    public BipedEntityModel<BipedEntityRenderState> provideArmorModelForSlot(EquipmentSlot slot) {
        ...
        var root = models.getModelPart(MythicModelHandler.ADAMANTITE);
