...
public class MythicEntityAttributes {
    ...
    public static final RegistryEntry<EntityAttribute> UNDEAD_BONUS_DAMAGE = RegistryHelper.entityAttribute("undead_bonus_damage", new ClampedEntityAttribute("attribute.name.mythicmetals.undead_bonus_damage", 0, -1024, 1024) {
        @Override
