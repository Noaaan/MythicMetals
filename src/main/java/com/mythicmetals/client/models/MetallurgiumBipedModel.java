...
public class MetallurgiumBipedModel extends BipedEntityModel<LivingEntity> {
    final EquipmentSlot slot;

    public MetallurgiumBipedModel(ModelPart root, EquipmentSlot slot) {
        super(root);
        this.slot = slot;
    }
    ...
    private void renderArmorPart(EquipmentSlot slot) {
        ...
        this.body.getChild("waist").visible = false;
        ...
        switch (slot) {
            ...
            case LEGS -> {
                this.body.visible = true;
                this.body.getChild("waist").visible = true;
