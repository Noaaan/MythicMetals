...
public class OreFeatureHelper {
    ...
    public static void ore(RegistryKey<PlacedFeature> ore) {
        var blacklist = CONFIG.blacklist().stream()
                .map(element -> (RegistryKey.of(RegistryKeys.BIOME, new Identifier(element))))
                .toList();
    ...
    public static void configuredFeature(Registerable<ConfiguredFeature<?, ?>> registerable, RegistryKey<ConfiguredFeature<?, ?>> featureKey, RuleTest rule, Block oreBlock, MythicMetalsConfig.OreConfig config) {
        ConfiguredFeatures.register(registerable, featureKey, Feature.ORE, configuredConfig(rule, oreBlock, config));
    }

    public static void configuredFeature(Registerable<ConfiguredFeature<?, ?>> registerable, RegistryKey<ConfiguredFeature<?, ?>> featureKey, ImmutableList<OreFeatureConfig.Target> target, MythicMetalsConfig.OreConfig config) {
        ConfiguredFeatures.register(registerable, featureKey, Feature.ORE, configuredConfig(target, config));
    }

    public static OreFeatureConfig configuredConfig(RuleTest test, Block block, MythicMetalsConfig.OreConfig config) {
        return new OreFeatureConfig(test, block.getDefaultState(), config.veinSize(), config.discardChance());
    }

    public static OreFeatureConfig configuredConfig(ImmutableList<OreFeatureConfig.Target> target, MythicMetalsConfig.OreConfig config) {
        return new OreFeatureConfig(target, config.veinSize(), config.discardChance());
    }

    public static void create(Registerable<PlacedFeature> registerable, RegistryKey<ConfiguredFeature<?, ?>> configuredFeatureKey, RegistryKey<PlacedFeature> placedFeatureKey, MythicMetalsConfig.OreConfig config) {
    ...
    public static void placeUniform(Registerable<PlacedFeature> registerable, RegistryKey<ConfiguredFeature<?, ?>> configuredFeatureKey, RegistryKey<PlacedFeature> placedFeatureKey, MythicMetalsConfig.OreConfig config) {
    ...
    public static void placeAboveBottom(Registerable<PlacedFeature> registerable, RegistryKey<ConfiguredFeature<?, ?>> configuredFeatureKey, RegistryKey<PlacedFeature> placedFeatureKey, MythicMetalsConfig.OreConfig config) {
        var featureLookup = registerable.getRegistryLookup(RegistryKeys.CONFIGURED_FEATURE);
    ...
    public static void placeTrapezoid(Registerable<PlacedFeature> registerable, RegistryKey<ConfiguredFeature<?, ?>> configuredFeatureKey, RegistryKey<PlacedFeature> placedFeatureKey, MythicMetalsConfig.OreConfig config) {
        var featureLookup = registerable.getRegistryLookup(RegistryKeys.CONFIGURED_FEATURE);
