...
public class Abilities {
    ...
    public static final Ability WATER_PROTECTION = new Ability("Natural Water Protection", 2);
    public static final Ability BLAST_PROTECTION = new Ability("Natural Blast Resistance", 6);
    public static final Ability DEPTH_STRIDER = new Ability("Natural Depth Strider", 2);
    ...
    public static final Ability RESPIRATION = new Ability("Natural Respiration", 2);
    ...
    public static void init() {
        ...
        BLAST_PROTECTION.addArmorSet(MythicArmor.BANGLUM, Style.EMPTY.withColor(Formatting.GOLD));
