...
public class MythicOreFeatures {
    ...
    public static ConfiguredFeature<?, ?> ORE_AETHERIUM = fixedOre(OreFeatureConfig.Rules.STONE_ORE_REPLACEABLES, MythicOres.AETHERIUM_ORE.getDefaultState(), CONFIG.oreAetheriumVeinSize, CONFIG.oreAetheriumMinHeight, CONFIG.oreAetheriumMaxHeight, CONFIG.oreAetheriumPerChunk, 0.25F);
    public static ConfiguredFeature<?, ?> ORE_AQUARIUM = fixedOre(OreFeatureConfig.Rules.STONE_ORE_REPLACEABLES, MythicOres.AQUARIUM_ORE.getDefaultState(), CONFIG.oreAquariumVeinSize,CONFIG.oreAquariumMinHeight, CONFIG.oreAquariumMaxHeight,CONFIG.oreAquariumPerChunk, 0.1F);
    public static ConfiguredFeature<?, ?> ORE_BANGLUM = fixedOre(OreFeatureConfig.Rules.STONE_ORE_REPLACEABLES, MythicOres.BANGLUM_ORE.getDefaultState(), CONFIG.oreBanglumVeinSize,CONFIG.oreBanglumMinHeight, CONFIG.oreBanglumMaxHeight,CONFIG.oreBanglumPerChunk, 0.2F);
    public static ConfiguredFeature<?, ?> ORE_CARMOT = fixedOre(OreFeatureConfig.Rules.STONE_ORE_REPLACEABLES, MythicOres.CARMOT_ORE.getDefaultState(), CONFIG.oreCarmotVeinSize,CONFIG.oreCarmotMinHeight, CONFIG.oreCarmotMaxHeight,CONFIG.oreCarmotPerChunk, 0.1F);
    public static ConfiguredFeature<?, ?> ORE_KYBER = fixedOre(OreFeatureConfig.Rules.STONE_ORE_REPLACEABLES, MythicOres.KYBER_ORE.getDefaultState(), CONFIG.oreKyberVeinSize, CONFIG.oreKyberMinHeight, CONFIG.oreKyberMaxHeight,CONFIG.oreKyberPerChunk, 0.3F);
    ...
    public static ConfiguredFeature<?, ?> ORE_MANGANESE = fixedOre(OreFeatureConfig.Rules.STONE_ORE_REPLACEABLES, MythicOres.MANGANESE_ORE.getDefaultState(), CONFIG.oreManganeseVeinSize,CONFIG.oreManganeseMinHeight, CONFIG.oreManganeseMaxHeight,CONFIG.oreManganesePerChunk, 0.15F);
    public static ConfiguredFeature<?, ?> ORE_MYTHRIL = fixedOre(OreFeatureConfig.Rules.STONE_ORE_REPLACEABLES, MythicOres.MYTHRIL_ORE.getDefaultState(), CONFIG.oreMythrilVeinSize,CONFIG.oreMythrilMinHeight, CONFIG.oreMythrilMaxHeight,CONFIG.oreMythrilPerChunk, 0.4F);
    public static ConfiguredFeature<?, ?> ORE_ORICHALCUM = fixedOre(OreFeatureConfig.Rules.STONE_ORE_REPLACEABLES, MythicOres.ORICHALCUM_ORE.getDefaultState(), CONFIG.oreOrichalcumVeinSize,CONFIG.oreOrichalcumMinHeight, CONFIG.oreOrichalcumMaxHeight,CONFIG.oreOrichalcumPerChunk, 0.4F);
    public static ConfiguredFeature<?, ?> ORE_OSMIUM = fixedOre(OreFeatureConfig.Rules.STONE_ORE_REPLACEABLES, MythicOres.OSMIUM_ORE.getDefaultState(), CONFIG.oreOsmiumVeinSize,CONFIG.oreOsmiumMinHeight, CONFIG.oreOsmiumMaxHeight,CONFIG.oreOsmiumPerChunk, 0.2F);
    public static ConfiguredFeature<?, ?> ORE_PLATINUM = fixedOre(OreFeatureConfig.Rules.STONE_ORE_REPLACEABLES, MythicOres.PLATINUM_ORE.getDefaultState(), CONFIG.orePlatinumVeinSize,CONFIG.orePlatinumMinHeight, CONFIG.orePlatinumMaxHeight,CONFIG.orePlatinumPerChunk, 0.3F);
    public static ConfiguredFeature<?, ?> ORE_PROMETHEUM = fixedOre(OreFeatureConfig.Rules.STONE_ORE_REPLACEABLES, MythicOres.PROMETHEUM_ORE.getDefaultState(), CONFIG.orePrometheumVeinSize,CONFIG.orePrometheumMinHeight, CONFIG.orePrometheumMaxHeight,CONFIG.orePrometheumPerChunk, 0.1F);
    public static ConfiguredFeature<?, ?> ORE_QUADRILLUM = fixedOre(OreFeatureConfig.Rules.STONE_ORE_REPLACEABLES, MythicOres.QUADRILLUM_ORE.getDefaultState(), CONFIG.oreQuadrillumVeinSize,CONFIG.oreQuadrillumMinHeight, CONFIG.oreQuadrillumMaxHeight,CONFIG.oreQuadrillumPerChunk, 0.2F);
    public static ConfiguredFeature<?, ?> ORE_RUNITE = fixedOre(OreFeatureConfig.Rules.STONE_ORE_REPLACEABLES, MythicOres.RUNITE_ORE.getDefaultState(), CONFIG.oreRuniteVeinSize,CONFIG.oreRuniteMinHeight, CONFIG.oreRuniteMaxHeight,CONFIG.oreRunitePerChunk, 0.0F);
    public static ConfiguredFeature<?, ?> ORE_SILVER = fixedOre(OreFeatureConfig.Rules.STONE_ORE_REPLACEABLES, MythicOres.SILVER_ORE.getDefaultState(), CONFIG.oreSilverVeinSize,CONFIG.oreSilverMinHeight, CONFIG.oreSilverMaxHeight,CONFIG.oreSilverPerChunk, 0.1F);
    public static ConfiguredFeature<?, ?> ORE_STARRITE = fixedOre(OreFeatureConfig.Rules.STONE_ORE_REPLACEABLES, MythicOres.STARRITE_ORE.getDefaultState(), CONFIG.oreStarriteVeinSize,CONFIG.oreStarriteMinHeight, CONFIG.oreStarriteMaxHeight,CONFIG.oreStarritePerChunk, 0.7F);
    public static ConfiguredFeature<?, ?> ORE_TIN = fixedOre(OreFeatureConfig.Rules.STONE_ORE_REPLACEABLES, MythicOres.TIN_ORE.getDefaultState(), CONFIG.oreTinVeinSize,CONFIG.oreTinMinHeight, CONFIG.oreTinMaxHeight,CONFIG.oreTinPerChunk, 0.3F);
    public static ConfiguredFeature<?, ?> ORE_UNOBTAINIUM = unobtainiumFeature(OreFeatureConfig.Rules.BASE_STONE_OVERWORLD, MythicOres.UNOBTAINIUM_ORE.getDefaultState(), CONFIG.oreUnobtainiumVeinSize, CONFIG.oreUnobtainiumMinHeight, CONFIG.oreUnobtainiumMaxHeight, CONFIG.oreUnobtainiumDiscardChance);
    public static ConfiguredFeature<?, ?> ORE_VERMICULITE = fixedOre(OreFeatureConfig.Rules.STONE_ORE_REPLACEABLES, MythicOres.VERMICULITE_ORE.getDefaultState(), CONFIG.oreVermiculiteVeinSize,CONFIG.oreVermiculiteMinHeight, CONFIG.oreVermiculiteMaxHeight,CONFIG.oreVermiculitePerChunk, 0.3F);
    // Nether Ores
    public static ConfiguredFeature<?, ?> ORE_MIDAS_GOLD = fixedOre(OreFeatureConfig.Rules.NETHERRACK, MythicOres.MIDAS_GOLD_ORE.getDefaultState(), CONFIG.oreMidasgoldVeinSize,CONFIG.oreMidasgoldMinHeight, CONFIG.oreMidasgoldMaxHeight,CONFIG.oreMidasgoldPerChunk, 0.1F);
    public static ConfiguredFeature<?, ?> ORE_PALLADIUM = fixedOre(OreFeatureConfig.Rules.NETHERRACK, MythicOres.PALLADIUM_ORE.getDefaultState(), CONFIG.orePalladiumVeinSize,CONFIG.orePalladiumMinHeight, CONFIG.orePalladiumMaxHeight,CONFIG.orePalladiumPerChunk, 0.1F);
