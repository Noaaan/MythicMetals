...
public class MythicArmor implements SimpleFieldProcessingSubject<ArmorSet> {
    ...
    public static final ArmorSet CARMOT = new CarmotArmorSet(ArmorMaterials.CARMOT, settings -> settings.rarity(Rarity.UNCOMMON));
    ...
    public static final ArmorSet LEGENDARY_BANGLUM = new BanglumArmorSet(ArmorMaterials.LEGENDARY_BANGLUM, settings -> settings.rarity(Rarity.UNCOMMON));
