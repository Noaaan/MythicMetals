...
public enum ToolMaterials implements ToolMaterial {
    ...
    BRONZE(2, 354, 5.5F, 2.5F, 14, () -> Ingredient.ofItems(MythicItems.BRONZE_INGOT)),
    CARMOT(3, 1130, 11.5F, 3.0F, 42, () -> Ingredient.ofItems(MythicItems.CARMOT_INGOT)),
    ...
    PROMETHEUM(3, 1472, 6.0F, 4.0F, 15, () -> Ingredient.ofItems(MythicItems.PROMETHEUM_INGOT)),
