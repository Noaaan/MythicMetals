...
public enum ToolMaterials implements ToolMaterial {
    ...
    CELESTIUM(5, 2270, 16.9F, 6.0F, 26, () -> Ingredient.ofItems(MythicItems.Ingots.CELESTIUM_INGOT)),
    ...
    HALLOWED(4, 1739, 12.0F, 5.0F, 20, () -> Ingredient.ofItems(MythicItems.Ingots.HALLOWED_INGOT)),
    ...
    MYTHRIL(4, 1445, 13.0F, 3.0F, 22, () -> Ingredient.ofItems(MythicItems.Ingots.MYTHRIL_INGOT)),
    ORICHALCUM(4, 2048, 6.0F, 4.0F, 16, () -> Ingredient.ofItems(MythicItems.Ingots.ORICHALCUM_INGOT)),
    OSMIUM(3, 584, 7.0F, 2.0F, 13, () -> Ingredient.ofItems(MythicItems.Ingots.OSMIUM_INGOT)),
    ...
    STAR_PLATINUM(3, 1300, 9.0F, 4.0F, 18, () -> Ingredient.ofItems(MythicItems.Ingots.STAR_PLATINUM)),
    STEEL(2, 600, 6.5F, 2.5F, 12, () -> Ingredient.ofItems(MythicItems.Ingots.STEEL_INGOT)),
    STORMYX(3, 1305, 8.0F, 3.5F, 20, () -> Ingredient.ofItems(MythicItems.Ingots.STORMYX_INGOT));
