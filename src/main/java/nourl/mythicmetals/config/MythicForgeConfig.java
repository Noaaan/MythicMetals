...
public class MythicForgeConfig {
    ...
    public static void createMaterialWorths() {
        ...
        MaterialWorths.addMaterials(new HashMap<>() {{
            put("copper", new HashMap<>() {{
                ...
                put("#c:copper_ores", new MaterialWorth(9, true));
            ...
            put("tin", new HashMap<>() {{
                ...
                put("#c:tin_ores", new MaterialWorth(9, true));
            ...
            put("silver", new HashMap<>() {{
                ...
                put("#c:silver_ores", new MaterialWorth(9, true));
            ...
            put("gold", new HashMap<>() {{
                ...
                put("#c:gold_ores", new MaterialWorth(9, true));
            ...
            put("adamantite", new HashMap<>() {{
                ...
                put("#c:adamantite_ores", new MaterialWorth(9, true));
            ...
            put("aetherium", new HashMap<>() {{
                ...
                put("#mythicmetals:aetherium_ores", new MaterialWorth(9, true));
            ...
            put("aquarium", new HashMap<>() {{
                ...
                put("#mythicmetals:aquarium_ores", new MaterialWorth(9, true));
            ...
            put("banglum", new HashMap<>() {{
                ...
                put("#mythicmetals:banglum_ores", new MaterialWorth(9, true));
            ...
            put("carmot", new HashMap<>() {{
                ...
                put("#mythicmetals:carmot_ores", new MaterialWorth(9, true));
            ...
            put("kyber", new HashMap<>() {{
                ...
                put("#mythicmetals:kyber_ores", new MaterialWorth(9, true));
            ...
            put("manganese", new HashMap<>() {{
                ...
                put("#c:manganese_ores", new MaterialWorth(9, true));
            ...
            put("midas_gold", new HashMap<>() {{
                ...
                put("#mythicmetals:midas_gold_ores", new MaterialWorth(9, true));
            ...
            put("mythril", new HashMap<>() {{
                ...
                put("#c:mythril_ores", new MaterialWorth(9, true));
            ...
            put("orichalcum", new HashMap<>() {{
                ...
                put("#c:orichalcum_ores", new MaterialWorth(9, true));
            ...
            put("osmium", new HashMap<>() {{
                ...
                put("#c:osmium_ores", new MaterialWorth(9, true));
            ...
            put("platinum", new HashMap<>() {{
                ...
                put("#c:platinum_ores", new MaterialWorth(9, true));
            ...
            put("prometheum", new HashMap<>() {{
                ...
                put("#mythicmetals:prometheum_ores", new MaterialWorth(9, true));
            ...
            put("quadrillum", new HashMap<>() {{
                ...
                put("#mythicmetals:quadrillum_ores", new MaterialWorth(9, true));
            ...
            put("runite", new HashMap<>() {{
                ...
                put("#mythicmetals:runite_ores", new MaterialWorth(9, true));
            ...
            put("starrite", new HashMap<>() {{
                ...
                put("#mythicmetals:starrite_ores", new MaterialWorth(9, true));
            ...
            put("stormyx", new HashMap<>() {{
                ...
                put("#mythicmetals:stormyx_ores", new MaterialWorth(9, true));
            ...
            put("truesilver", new HashMap<>() {{
                ...
                put("#mythicmetals:truesilver_ores", new MaterialWorth(9, true));
    ...
    private static void createOreRecipes() {
        ...
        ForgeRecipes.addRecipes(new HashMap<>() {{
            put(new HashMap<>() {{
                put("#mythicmetals:starrite_ores", 2);
            }}, new RecipeOutput("mythicmetals:starrite_ingot", 3, 10, 1));
        }}, false);
        // Stormyx
        ForgeRecipes.addRecipes(new HashMap<>() {{
            put(new HashMap<>() {{
                put("#mythicmetals:stormyx_ores", 2);
        ...
        ForgeRecipes.addRecipes(new HashMap<>() {{
            put(new HashMap<>() {{
                put("#mythicmetals:truesilver_ores", 2);
            }}, new RecipeOutput("mythicmetals:truesilver_ingot", 3, 10, 2));
        }}, false);
        // Unobtainium
        ForgeRecipes.addRecipes(new HashMap<>() {{
            put(new HashMap<>() {{
                put("#mythicmetals:unobtainium_ores", 2);
